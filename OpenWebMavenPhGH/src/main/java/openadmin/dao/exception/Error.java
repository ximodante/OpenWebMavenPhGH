...
public class Error {
    ...
    public void DataException(ErrorDao pError, String pText, String pClassError, TypeEnvironment pEnvironment, LangTypeEdu pLangType) {    	    	
    	...
    	if (pError.equals(ErrorDao.PERSIST)&& pClassError.equals("org.hibernate.exception.ConstraintViolationException")){    		
    		...
    		message = pText + "\n" + pLangType.msgError("ERROR_NO_PK");    		
    	}

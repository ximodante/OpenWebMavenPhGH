...
public class PrimeFacesEdu {

    private static final Logger LOG = Logger.getLogger(PrimeFacesEdu.class.getName());
    ...
    private static final PrimeFacesEdu INSTANCE = new PrimeFacesEdu();
    
    private final Dialog dialog;
    private final Ajax ajax;
    
    private PrimeFacesEdu() {
        dialog = new Dialog();
        ajax = new Ajax();
    }

    public static PrimeFacesEdu current() {
        return INSTANCE;
    }
